...
export class FormManager {
  constructor() {
    ...
    this.buttonRequirements = {
      ...
      'generate-copy-create-planner': ['create-planner-spec'],
      'generate-copy-create-codegen': ['create-codegen-spec', 'create-codegen-plan'],
      'generate-copy-create-review': ['create-review-code'],
